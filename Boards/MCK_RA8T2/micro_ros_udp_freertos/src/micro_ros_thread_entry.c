...
/*********************************************************************************************************************************
 * Micro ROS FreeRTOS task entry point
 * This function initializes the motor control and sets up the micro-ROS transport. Then it starts the micro-ROS application.
...
void micro_ros_thread_entry(void *pvParameters)
{
    ...
    remote_addr.sin_addr = FreeRTOS_inet_addr("192.168.1.100");
